...
def read_servo_settings_file(fname=''):
    ...
    if os.path.exists(fname):                                        # case the servo_settings file exists
        ...
        # managing upgrade from release older than 5.0
        if 'b_extra_home' in srv_settings.keys() or 'b_extra_sides' in srv_settings.keys():
        # case the key 'b_extra_home' or b_extra_sides are in the settings file (keys used before release 5.0)
            print("\n\n\n\n\n")
            print("################################################################################")
            print("#                                                                              #")
            print("#  It looks like you have upgraded from a release older than 5.0               #")
            print("#                                                                              #")
            print("#  Before using 'Cubotino_T_servos_GUI.py, run 'Cubotino_T_servos.py --set 0'  #")
            print("#  This is needed only one time, to get the new parameters automatically       #")
            print("#  added to the settings files.                                                #")
            print("#                                                                              #")
            print("################################################################################")
            print("\n\n\n\n\n")
            quit()                                     # script is terminated
...
def read_cam_settings_file(fname=''):
    ...
    if os.path.exists(fname):                                  # case the settings file exists
        ...
        print('Could not find Cubotino_T_settings.txt')  # feedback is printed to the terminal                                  
